# Generated by Django 4.1.5 on 2023-04-07 10:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("Acession", models.CharField(blank=True, max_length=200)),
                ...
                ("All_protocols", models.CharField(blank=True, max_length=1500)),
                ("seq_types", models.CharField(blank=True, max_length=200)),
                ("GSE", models.CharField(blank=True, max_length=200)),
                ("GSE_Supplementary", models.CharField(blank=True, max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("gwips", models.BooleanField(default=False)),
                ("ribocrypt", models.BooleanField(default=False)),
                ("ftp", models.BooleanField(default=False)),
                ("Study_Accesion", models.CharField(blank=True, max_length=200)),
                ...
                ("ProjectID", models.CharField(blank=True, max_length=200)),
                ...
                ("KO", models.CharField(blank=True, max_length=200)),
                ("KD", models.CharField(blank=True, max_length=200)),
                ("KI", models.CharField(blank=True, max_length=200)),
                ("FRACTION", models.CharField(blank=True, max_length=200)),
                ("Custom_columns", models.CharField(blank=True, max_length=500)),
                (
                    "riboseq",
                    models.ForeignKey(
